...
$(document).ready(function () {
    $(function () {
        ...
        $("a.consulta").on("click", function (e) {
            $('.inbox-body').load(this.href, function () {
...
$(".btn_send").on("click", function (event) {
    ...
    var data = $(form).serialize() + "&confirma=" + acao;
    var modulo = $("#demo-form2").attr("action");
    ...
    $.ajax({
        ...
        success: function () {
            console.log('entrou');
            if (acao == "end") {
                window.location.href = "http://drmedapp.azurewebsites.net/Consulta/Agenda";
            }
        }
    });
